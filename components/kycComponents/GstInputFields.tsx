    ...
    <div className="flex flex-col w-full max-w-[850px]">
      ...
      <div className="relative mt-4">
        <input
          ...
          maxLength={18}
          className="peer h-[65px] w-full rounded-2xl border border-gray-300 px-4  text-base text-gray-800 placeholder-gray-400 focus:placeholder-transparent focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none"
        />
        <label
