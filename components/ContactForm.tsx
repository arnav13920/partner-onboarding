...
const emptyContact: Contact = { firstName: "", lastName: "", mobile: "", email: "" };
    ...
    <>
      <div className="px-14 py-6 max-w-5xl">
        ...
        <div className="mt-4">
          ...
          <div className="mt-3 mb-3">
            ...
            <div className="flex items-start gap-3 mt-2 text-[#475569]">
              ...
              This helps us identify the main point of contact and personalize your experience. All important communication will be directed here.
              </p>
            </div>
          </div>
        </div>
        ...
        {contacts.map((c, idx) => {
          ...
          return (
            <div key={idx} className="mt-4">
              <h3 className="font-bold text-[20px] text-[#575D6A] mt-4">Contact {idx + 1}</h3>
              <div className=" grid grid-cols-2 gap-4 max-w-[850px]">
                ...
                <div className="relative mt-4">
                  <input
                    ...
                    value={c.firstName}
                    onChange={(e) =>
                      setContacts((prev) => prev.map((pc, i) => i === idx ? { ...pc, firstName: e.target.value.replace(/[^A-Za-z]/g, "") } : pc))
                    }
                    maxLength={50}
                ...
                <div className="relative mt-4">
                  <input
                    ...
                    value={c.lastName}
                    onChange={(e) =>
                      setContacts((prev) => prev.map((pc, i) => i === idx ? { ...pc, lastName: e.target.value.replace(/[^A-Za-z]/g, "") } : pc))
                    }
                    maxLength={50}
                ...
                <div className="relative mt-4">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#575D6A]">+91</span>
                  <input
                    id={`mobile-${idx}`}
                    type="text"
                    ...
                    onChange={(e) => {
                      ...
                      setContacts((prev) => prev.map((pc, i) => i === idx ? { ...pc, mobile: digitsOnly } : pc));
                    }}
                    inputMode="numeric"
                    maxLength={10}
                ...
                <div className="relative mt-4">
                  <input
                    ...
                    value={c.email}
                    onChange={(e) => setContacts((prev) => prev.map((pc, i) => i === idx ? { ...pc, email: e.target.value } : pc))}
                    maxLength={100}
        ...
        {contacts.length < MAX_CONTACTS && (
          ...
          >
            <Image src="/images/AddIcon.png" alt="Add Icon" width={24} height={24}/>
